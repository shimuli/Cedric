...
namespace Cedric.Model.Phamacore
{
    public partial class Branch
    {
        ...
        public bool? Custexpupdate { get; set; }
        public bool? Suppexpupdate { get; set; }
        public bool? Invexpupdate { get; set; }
        public bool? Brexpupdate { get; set; }
        public bool? Glexpupdate { get; set; }
        public int? Brandgenericsale { get; set; }
        public bool? Blockreceipt { get; set; }
        public bool? Blockpayment { get; set; }
        public bool? Kahspprice { get; set; }
        public bool? Kahcashprice { get; set; }
        public bool? Kahcashpricepromo { get; set; }
        public bool? Kahmembers { get; set; }
        public int? Nextrptdetnum { get; set; }
        public int? Nextpaydetnum { get; set; }
        public int? Nextporderdetnum { get; set; }
        public int? Nextsinvdetnum { get; set; }
        public int? Nextgretdetnum { get; set; }
        public int? Nextgrndetnum { get; set; }
        public int? Nextpayentrynum { get; set; }
        public int? Nextrptentrynum { get; set; }
        ...
        public string Cashinvoicepartwhole { get; set; }
        public bool? Lockpartwholecashinvoice { get; set; }
        public int? Defpricingmodecashinvoice { get; set; }
        public bool? Lockdefpricingmodecashinvoice { get; set; }
        public bool? Lockdefpricingmodecash { get; set; }
        public bool? Showallcustomer { get; set; }
        public string Borderpartwhole { get; set; }
        public bool? Lockpartwholeborder { get; set; }
        public string Btranspartwhole { get; set; }
        public bool? Lockpartwholebtrans { get; set; }
        public string Brnpartwhole { get; set; }
        public bool? Lockpartwholebrn { get; set; }
        public bool? Showallcustomertrans { get; set; }
        public bool? ImpInventory { get; set; }
        public bool? ImpInvAll { get; set; }
        public bool? ImpInvDesc { get; set; }
        public bool? ImpInvShelf { get; set; }
        public bool? ImpInvProdClass { get; set; }
        public bool? ImpInvFormulation { get; set; }
        public bool? ImpInvMainclass { get; set; }
        public bool? ImpInvCustDiscount { get; set; }
        public bool? ExpInvCustDiscount { get; set; }
        public int? Nextmpickno { get; set; }
        public int? Transferbcode { get; set; }
        public byte[] Cbrow { get; set; }
        public int? Nextprelponum { get; set; }
    }
}
